"""
Command Line Interface for Frozen Section Sentinel Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="frozen-section-sentinel-agent", description="Frozen Section Sentinel Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  FROZEN SECTION SENTINEL AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Frozen Section Sentinel Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Frozen Section Sentinel Agent API server on http://{args.host}:{args.port}")
