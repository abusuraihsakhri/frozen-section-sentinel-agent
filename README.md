...
**Frozen Section Sentinel Agent** is an advanced analytical and computational platform implementing Intraoperative Pathology Margin & Discordance Supervisor.
...
- **`MarginProximityAgent`**: Specialized Sub-Agent 1 for frozen-section-sentinel-agent
- **`PermanentCorrelationAgent`**: Specialized Sub-Agent 2 for frozen-section-sentinel-agent
- **`TATUrgencyAgent`**: Specialized Sub-Agent 3 for frozen-section-sentinel-agent
