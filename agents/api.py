"""
FastAPI REST API Server for Frozen Section Sentinel Agent.
"""
...
app = FastAPI(
    title="Frozen Section Sentinel Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "frozen-section-sentinel-agent", "domain": "Digital Pathology & Histology Systems", "standard": "CAP Cancer Protocols / DICOM WSI PS3.16", "version": "3.0.0-ENTERPRISE"}
