import pytest
from frozen_sentinel import MarginProximityAgent, PermanentCorrelationAgent, TATUrgencyAgent, IntraoperativeCoordinator, main


def test_sub_agents():
    a1 = MarginProximityAgent()
    alerts1 = a1.evaluate({"metric_primary": 35.0})
    assert len(alerts1) == 1

    a2 = PermanentCorrelationAgent()
...
def test_coordinator():
    coord = IntraoperativeCoordinator()
...
def test_domain_registry():
    from frozen_sentinel import DomainKnowledgeRegistry
